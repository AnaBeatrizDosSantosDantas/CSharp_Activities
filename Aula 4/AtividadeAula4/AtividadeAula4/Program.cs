...
namespace AtividadeAula4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Registro: " + idade + " anos de idade, código " + codigo + " e sexo: " + sexo);
            Console.WriteLine();
            ...
            Console.WriteLine("Separador decimal invariant culture: " + medida.ToString("F3", CultureInfo.InvariantCulture) + " reais.");
        }
    }
}
